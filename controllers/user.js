...
exports.getAccount = (req, res) => {
      ...
      if(req.user.secret) {
        var qrData = sprintf('otpauth://totp/%s?secret=%s', 'XHimera Wallet: '+req.user.email, key);
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      ...
      subject: 'Your XHimeraWallet.io password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@denariuswallet.io',
      subject: 'Reset your password on XHimeraWallet.io',
